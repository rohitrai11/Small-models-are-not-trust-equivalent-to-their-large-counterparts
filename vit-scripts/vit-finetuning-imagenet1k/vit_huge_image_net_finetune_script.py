...
# from huggingface_hub import login
# login("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")
...
#         # Predictions for this micro-batch
#         preds = torch.argmax(logits, dim=1)
...
#             # Compute effective batch metrics
...
# print("Training complete.")
# model.save_pretrained("./vit_head_only_huge_224")
# print("Model saved.")
